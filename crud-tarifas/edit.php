...
$sql  = $wpdb->prepare("SELECT * FROM " . TABLE_NAME . " WHERE codServicio = %d", $id);
...
<form method="post" action="<?= admin_url('admin-post.php') ?>" class="frm-detail-fruits">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name="descricioServicio" id="descricioServicio" required
                value="<?= $item->descricioServicio ?>">
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name="tipoServicio" id="tipoServicio" required
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <select class="form-control" name="condicionSevicio" id="condicionSevicio">
                <option value="FIJO" <?php selected($item->condicionSevicio, "FIJO"); ?>>FIJO</option>
                <option value="ESPECIAL" <?php selected($item->condicionSevicio, "ESPECIAL"); ?>>ESPECIAL</option>
            </select>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="date" class="form-control" name="vigenciaSrart" id="vigenciaSrart" required
                value="<?= $item->vigenciaSrart ?>">
        </div>
    </div>
    <div class="form-group row">
        <label for="vigenciaEnd" class="col-sm-2 col-form-label">Hasta</label>
        <div class="col-sm-10">
            <input type="date" class="form-control" name="vigenciaEnd" id="vigenciaEnd" required
                value="<?= $item->vigenciaEnd ?>">
        </div>
    </div>
    <div class="form-group row">
        <label for="montoPagar" class="col-sm-2 col-form-label">Monto</label>
        <div class="col-sm-10">
            <input type="text" class="form-control" name="montoPagar" id="montoPagar" required
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" name="titulo" id="titulo" required value="<?= $item->titulo ?>">
        </div>
    </div>
    <div class="form-group row">
    ...
    <div>
        <input type="hidden" name="id" value="<?= $item->codServicio ?>">
